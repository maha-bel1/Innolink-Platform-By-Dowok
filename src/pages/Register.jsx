...
const Register = () => {
  ...
  const renderRoleForm = () => {
    switch (selectedRole) {
      case 'researcher':
        return <ResearcherForm formData={formData} onChange={handleChange} errors={errors} />;
      case 'company':
        return <CompanyForm formData={formData} onChange={handleChange} errors={errors} />;
      case 'investor':
        return <InvestorForm formData={formData} onChange={handleChange} errors={errors} />;
      case 'admin':
        return <AdminForm formData={formData} onChange={handleChange} errors={errors} />;
      default:
        return null;
    }
  };
